...
def affine_bn_relu_dropout_forward(x, w, b, gamma, beta, bn_param, normalization, dropout_param):
    """
    Convenience layer that perorms an affine transform followed by a BN and ReLU
    """
    fc_cache, bn_cache, relu_cache = None, None, None
    ...
    out, dropout_cache = dropout_forward(x, dropout_param)
...
def affine_bn_relu_dropout_backward(dout, cache, normalization):
    """
    Backward pass for the affine-bn-relu convenience layer
    """
